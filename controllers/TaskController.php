...
class TaskController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            $task = $this->taskService->createTask(\Yii::$app->request->post());
            if ($task) {
    ...
    {
        if ($this->request->isPost) {
            $task = $this->taskService->updateTask($id, \Yii::$app->request->post());
    ...
    public function actionDelete($id)
    {
        ...
        \Yii::$app->session->setFlash('danger', 'task has been removed');
    ...
    {
        if (($model = $this->taskService->findTask($id)) !== null) {
            return $model;
        }
